...
router.put('/product-categories/:categoryId',  adminController.editProductCategory);
router.patch('/product-categories/:categoryId/status',  adminController.toggleProductCategoryStatus);
